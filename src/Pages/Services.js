...
const Services = () => {
    ...
    return (
        <div className="min-h-[80vh] flex justify-center items-center mx-auto mt-[11vh] mb-[3vh] md:pt-5 animate-appear">
            <section className="bg-white rounded-2xl md:px-16">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-headerTitle text-bleu-vert font-extrabold">
